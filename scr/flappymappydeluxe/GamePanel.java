	...
	private void LoadImage() {
        ...
        if (activeBirdSkin != null) {
            switch (activeBirdSkin) {
                case "Purple":
                    birdSkinImage = ImageIO.read(new File("NotFlappyBird-main/ShopSkins/purpleBirdIdle.png"));
                    birdSkinImageFlap = ImageIO.read(new File("NotFlappyBird-main/ShopSkins/purpleBirdFlap.png"));
                    break;
                case "Blue":
                    birdSkinImage = ImageIO.read(new File("NotFlappyBird-main/ShopSkins/blueBirdIdle.png"));
                    birdSkinImageFlap = ImageIO.read(new File("NotFlappyBird-main/ShopSkins/blueBirdFlap.png"));
                    break;
                case "The Original":
                    birdSkinImage = ImageIO.read(new File("NotFlappyBird-main/ShopSkins/yellowBirdIdle.png"));
                    birdSkinImageFlap = ImageIO.read(new File("NotFlappyBird-main/ShopSkins/yellowBirdFlap.png"));
                    break;
                case "Original":
                default:
                    birdSkinImage = ImageIO.read(new File("NotFlappyBird-main/Images/redbird-midflap.png"));
                    birdSkinImageFlap = ImageIO.read(new File("NotFlappyBird-main/Images/redbirdnewflap.png"));
                    break;
            }
        } else {
            birdSkinImage = ImageIO.read(new File("NotFlappyBird-main/Images/redbird-midflap.png"));
