...
public class MenuPanel extends JPanel {
    ...
    public MenuPanel(CardLayout cardLayout, JPanel mainPanel, AudioPlayer audioPlayer) {
        ...
        LoadImage();
        audioPlayer.play("Music/1-01. Main Theme (Title Screen).wav"); // Plays the background music
        ...
        startButton = new Button(200, 225, 225, 125, "", "Images/PlayButton.png");
        shopButton = new Button(210, 340, 175, 90, "", "Images/ShopButton.png");
        ...
        this.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                if (startButton.isClicked(e)) {
                    ...
                    switchMusic("Music/1-04.-Strike-the-Earth_-_Plains-of-Passage_.wav");
                    System.out.println("Play Button clicked");
                }
               
                if (shopButton.isClicked(e)) {
                    cardLayout.show(mainPanel, "shop");
                    switchMusic("Music/Ace-Attorney-18-Marvin-Grossberg-_-Age_-Regret_-Retribution.wav");
    ...
    private void LoadImage() {
        try {
            ...
            img2 = ImageIO.read(new File("Images/NotFlappyBirdTitle.png"));
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
