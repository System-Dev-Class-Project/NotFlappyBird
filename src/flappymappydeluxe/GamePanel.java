...
public class GamePanel extends JPanel {
	...
	private void LoadImage() {
        ...
        // Load corresponding images based on active skins, the bird skins are handled in the BirdAnimation Class itself as we have to account for the Mini PowerUp, assigning the correctly sized bird image couple for each case.
