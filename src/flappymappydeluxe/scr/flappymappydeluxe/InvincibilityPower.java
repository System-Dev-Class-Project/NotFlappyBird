...
public class InvincibilityPower {
    ...
    public InvincibilityPower(WallImage wall) {
        this.x = wall.X + 10;
    ...
    private void loadPowerUpImage() {
        try {
            powerUpImg = ImageIO.read(new File("src\\flappymappydeluxe\\Images\\InvincibilityPower.png"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void movePowerUp(WallImage wall) {
